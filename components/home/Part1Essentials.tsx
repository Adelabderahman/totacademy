...
export default function Part1Essentials() {
  const { language } = useLanguage();
  const t = coreI18n[language] || coreI18n['ar'];
  const courses = programsDB.part1;

  return (
    <section className="section-wrapper" id="part1-section">
      <div className="part1-header">
        <h2>{t.part1_main_title}</h2>
        <p>{t.part1_main_desc}</p>
      </div>

      <SwipeSlider
        containerId="swipe-container-1"
        wrapperId="modern-cards-wrapper-1"
        dotsId="swipe-dots-1"
