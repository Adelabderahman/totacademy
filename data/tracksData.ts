...
export const coreI18n: Record<'ar' | 'en' | 'fr', Record<string, string>> = {
  ar: {
    ...
    tracks_orbit_tech: "تكنولوجيا التعليم",
    tracks_orbit_marketing: "التسويق الرقمي",
    tracks_orbit_media: "الإعلام الرقمي",
    tracks_orbit_creativity: "التفكير الإبداعي",
    tracks_orbit_leadership: "القيادة التنفيذية",
    tracks_orbit_ai: "الذكاء الاصطناعي",
    tracks_orbit_pedagogy: "تصميم المناهج",
    tracks_orbit_speaking: "فنون الإلقاء",
    tracks_orbit_gamification: "التلعيب التعليمي",
    tracks_orbit_consulting: "الاستشارات المهنية",
  ...
  en: {
    ...
    tracks_orbit_tech: "Educational Technology",
    tracks_orbit_marketing: "Digital Marketing",
    tracks_orbit_media: "Digital Media",
    tracks_orbit_creativity: "Creative Thinking",
    ...
    tracks_orbit_gamification: "Educational Gamification",
    tracks_orbit_consulting: "Professional Consulting",
  ...
  fr: {
    ...
    tracks_orbit_tech: "Technologie Éducative",
    tracks_orbit_marketing: "Marketing Digital",
    tracks_orbit_media: "Médias Numériques",
    tracks_orbit_creativity: "Pensée Créative",
    ...
    tracks_orbit_gamification: "Ludopédagogie Éducative",
    tracks_orbit_consulting: "Conseil Professionnel",
