...
export const coreI18n = {
  ar: {
    ...
    join_elite_btn: "انضم لنخبة المدربين",
    join_modal_title: "انضم إلى نخبة مدربي الأكاديمية",
    join_modal_subtitle: "كن جزءاً من مجتمع تدريبي رائد واستثمر شغفك وخبرتك لصناعة الأثر في الوطن العربي والعالم",
    form_name_label: "الاسم واللقب",
    form_name_placeholder: "مثال: د. محمد أحمد",
    form_email_label: "البريد الإلكتروني",
    form_email_placeholder: "example@domain.com",
    form_phone_label: "رقم الواتساب / الهاتف",
    form_phone_placeholder: "+213 555 123 456",
    form_country_label: "الدولة / المحافظة أو الولاية",
    form_country_placeholder: "مثال: الجزائر - العاصمة",
    form_specialty_label: "مجال التخصص التدريبي",
    form_specialty_select: "اختر مجال التخصص...",
    form_exp_label: "سنوات الخبرة في التدريب",
    form_exp_select: "اختر سنوات الخبرة...",
    form_exp_1: "أقل من 3 سنوات",
    form_exp_2: "من 3 إلى 5 سنوات",
    form_exp_3: "من 5 إلى 10 سنوات",
    form_exp_4: "أكثر من 10 سنوات",
    form_portfolio_label: "رابط الملف المهني (LinkedIn / موقع شخصي)",
    form_portfolio_placeholder: "https://linkedin.com/in/username",
    form_cv_label: "تحميل السيرة الذاتية (CV)",
    form_cv_hint: "انقر لاختيار الملف أو اسحبه هنا (PDF أو Word، الحد الأقصى 10MB)",
    form_cv_selected: "الملف المحدد:",
    form_cv_remove: "حذف الملف",
    form_bio_label: "نبذة عن أبرز إنجازاتك التدريبية",
    form_bio_placeholder: "اكتب بإيجاز عن البرامج التي قدمتها والفئات المستهدفة...",
    form_terms_label: "أوافق على معايير وشروط الانضمام لنخبة مدربي TOT Academy والالتزام بميثاق الجودة والأخلاقيات المهنية.",
    form_submit_btn: "إرسال طلب الانضمام",
    form_submitting: "جاري إرسال الطلب...",
    form_success_title: "تم استلام طلبك بنجاح! 🎓",
    form_success_desc: "شكراً لاهتمامك بالانضمام إلى نخبة مدربي TOT Academy. سيقوم فريق الاعتماد الأكاديمي بمراجعة ملفك والتواصل معك عبر الواتساب أو البريد الإلكتروني خلال 48 ساعة لتحديد موعد المقابلة.",
    form_close_btn: "إغلاق النافذة",
    form_required_alert: "يرجى ملء جميع الحقول المطلوبة والموافقة على الشروط."
  },
  en: {
    top_signup: "Sign Up",
    ...
    join_elite_btn: "Join Elite Trainers",
    join_modal_title: "Join Our Elite Trainer Network",
    join_modal_subtitle: "Become part of a leading training community and leverage your passion and expertise to make an impact",
    form_name_label: "Full Name",
    form_name_placeholder: "e.g. Dr. John Doe",
    form_email_label: "Email Address",
    form_email_placeholder: "example@domain.com",
    form_phone_label: "WhatsApp / Phone Number",
    form_phone_placeholder: "+213 555 123 456",
    form_country_label: "Country / State or Province",
    form_country_placeholder: "e.g. Algeria - Algiers",
    form_specialty_label: "Training Field / Specialization",
    form_specialty_select: "Select specialization...",
    form_exp_label: "Years of Training Experience",
    form_exp_select: "Select experience...",
    form_exp_1: "Less than 3 years",
    form_exp_2: "3 to 5 years",
    form_exp_3: "5 to 10 years",
    form_exp_4: "More than 10 years",
    form_portfolio_label: "Professional Profile (LinkedIn / Website)",
    form_portfolio_placeholder: "https://linkedin.com/in/username",
    form_cv_label: "Upload Resume / CV",
    form_cv_hint: "Click to choose file or drag & drop (PDF or Word, max 10MB)",
    form_cv_selected: "Selected file:",
    form_cv_remove: "Remove file",
    form_bio_label: "Brief Summary of Achievements & Experience",
    form_bio_placeholder: "Briefly describe your training programs and target audience...",
    form_terms_label: "I agree to the criteria and terms of joining TOT Academy's trainer network and commit to the code of quality and ethics.",
    form_submit_btn: "Submit Application",
    form_submitting: "Submitting application...",
    form_success_title: "Application Received Successfully! 🎓",
    form_success_desc: "Thank you for your interest in joining TOT Academy's elite trainers. Our academic team will review your profile and contact you via WhatsApp or Email within 48 hours.",
    form_close_btn: "Close Window",
    form_required_alert: "Please fill in all required fields and accept the terms."
  },
  fr: {
    ...
    join_elite_btn: "Rejoindre l'élite des formateurs",
    join_modal_title: "Rejoindre le réseau d'élite des formateurs",
    join_modal_subtitle: "Intégrez une communauté de formation d'excellence et valorisez votre expertise pour créer un impact durable",
    form_name_label: "Nom et prénom",
    form_name_placeholder: "Ex: Dr. Martin Dupont",
    form_email_label: "Adresse e-mail",
    form_email_placeholder: "exemple@domaine.com",
    form_phone_label: "WhatsApp / Téléphone",
    form_phone_placeholder: "+213 555 123 456",
    form_country_label: "Pays / Région ou Ville",
    form_country_placeholder: "Ex: Algérie - Alger",
    form_specialty_label: "Spécialité de formation",
    form_specialty_select: "Sélectionnez votre spécialité...",
    form_exp_label: "Années d'expérience en formation",
    form_exp_select: "Sélectionnez l'expérience...",
    form_exp_1: "Moins de 3 ans",
    form_exp_2: "De 3 à 5 ans",
    form_exp_3: "De 5 à 10 ans",
    form_exp_4: "Plus de 10 ans",
    form_portfolio_label: "Profil professionnel (LinkedIn / Site web)",
    form_portfolio_placeholder: "https://linkedin.com/in/username",
    form_cv_label: "Téléverser votre CV",
    form_cv_hint: "Cliquez pour choisir un fichier ou glissez-déposez (PDF ou Word, max 10 Mo)",
    form_cv_selected: "Fichier sélectionné :",
    form_cv_remove: "Supprimer le fichier",
    form_bio_label: "Aperçu de vos réalisations et compétences",
    form_bio_placeholder: "Décrivez brièvement vos programmes et votre public cible...",
    form_terms_label: "J'accepte les critères et conditions d'adhésion au réseau TOT Academy et m'engage à respecter la charte de qualité.",
    form_submit_btn: "Envoyer ma candidature",
    form_submitting: "Envoi en cours...",
    form_success_title: "Candidature reçue avec succès ! 🎓",
    form_success_desc: "Merci pour votre intérêt à rejoindre TOT Academy. Notre équipe académique examinera votre dossier et vous contactera sous 48 heures par WhatsApp ou e-mail.",
    form_close_btn: "Fermer la fenêtre",
    form_required_alert: "Veuillez remplir tous les champs obligatoires et accepter les conditions."
  }
};
